      ...
      <div className='max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start'>
        ...
        <div className='space-y-8'>
          <div>
            ...
            <div className='w-20 h-1 bg-golden-rod-yellow mb-8'></div>
          </div>
        ...
        <div className='space-y-8'>
          ...
          <div className='space-y-4'>
            <h3 className='text-2xl font-semibold text-golden-rod-yellow font-montserrat'>
              Core Skills
            </h3>
            <div className='flex flex-wrap gap-3'>
              {[
                ...
                <span
                  key={skill}
                  className='px-4 py-2 bg-golden-rod-yellow/20 text-golden-rod-yellow rounded-full text-sm font-medium border border-golden-rod-yellow/30 hover:bg-golden-rod-yellow/30 transition-colors duration-300'>
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <div className='flex gap-2 text-golden-rod-yellow'>
                  <span>English</span> • <span>German</span> •{' '}
              ...
              <div>
                ...
                <div className='flex flex-wrap gap-2 text-sm'>
                  {[
                    ...
                    <span
                      key={cert}
                      className='px-3 py-1 bg-blue-underling/20 text-blue-underling rounded-full border border-blue-underling/30'>
                      {cert}
                    </span>
                  ))}
                </div>
